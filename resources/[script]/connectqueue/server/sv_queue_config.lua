    ...
    if xPlayer.permission_level >= 9 then
        ...
        if name then
            ...
            if not Config.Priority[identifier] then
                ...
                TriggerClientEvent('chatMessage', source, " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, " ^2 " .. name .. "^0 ba priority ^1" .. perm .. "^0 ezafe shod!")
            else
                TriggerClientEvent('chatMessage', source, " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, " ^0In shakhs dar list hast!")
            end
        else
        ...
        TriggerClientEvent('chatMessage', source, " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, " ^0Shoma dastresi kafi baraye in dastor ra nadarid!")
    end
