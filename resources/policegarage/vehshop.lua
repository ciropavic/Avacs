local vehshop = {
	...
	menu = {
		...
		["super"] = { 
			...
			name = "super",
			buttons = { 
				{name = "pol718", costs = 0, description = {}, model = "pol718"},
			}
		},
		["muscle"] = { 
			title = "muscle", 
			name = "muscle",
			buttons = { 
				{name = "sheriff", costs = 0, description = {}, model = "sheriff"},
			}
		},
		["offroad"] = { 
			title = "off-road", 
			name = "off-road",
			buttons = { 
				{name = "sheriff2", costs = 0, description = {}, model = "sheriff2"},
			}
		},
		["suvs"] = { 
			title = "suvs", 
			name = "suvs",
			buttons = { 
				{name = "sheriff3", costs = 0, description = {}, model = "sheriff3"},
			}
		},
		["vans"] = { 
			title = "vans", 
			name = "vans",
			buttons = { 
				{name = "policet", costs = 0, description = {}, model = "policet"},
			}
		},
		["sedans"] = { 
			title = "sedans", 
			name = "sedans",
			buttons = { 
			    {name = "police", costs = 0, description = {}, model = "police"},
		...
		["motorcycles"] = { 
			...
			name = "motorcycles",
			buttons = { 
				{name = "policeb", costs = 0, description = {}, model = "policeb"},
			}
		},
	}
}
