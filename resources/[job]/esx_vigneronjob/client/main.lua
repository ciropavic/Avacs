...
function OpenVigneActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vigne_actions', {
			...
			if data.current.value == 'boss_actions' then
				TriggerEvent('esx_society:openbossirs', 'vigne', function(data, menu)
					menu.close()
				end)
			end
		end, function(data, menu)
...
function OpenVehicleSpawnerMenu()
	...
	if Config.EnableSocietyOwnedVehicles then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
					...
					ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones.VehicleSpawnPoint.Pos, 90.0, function(vehicle)
						...
						local upperCase = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
                                ...
                                SetVehicleNumberPlateText(vehicle, "VIG " .. output)
								Citizen.CreateThread(function()
			                 	Citizen.Wait(2000)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner', {
				...
				ESX.Game.SpawnVehicle(model, Config.Zones.VehicleSpawnPoint.Pos, 83.65, function(vehicle)
					local playerPed = GetPlayerPed(-1)
					spawned = true
					TaskWarpPedIntoVehicle(playerPed,  vehicle,  -1)
					local upperCase = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
			...
			ESX.ShowNotification("Shoma ghablan yek mashin dar avardid")
			end
	end
end
