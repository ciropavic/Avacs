local Keys = {
  ...
  RegisterCommand('sl', function(source, args, user)
	...
	if args[1] then
		...
		if tonumber(args[1]) then
				...
				if GetPlayerName(GetPlayerFromServerId(target)) ~= "**Invalid**" then
					...
					if GetPlayerName(PlayerId()) ~= GetPlayerName(GetPlayerFromServerId(target)) then
						...
						if GetDistanceBetweenCoords(coords, tcoords, true) < 2 then
							...
							TriggerEvent('chatMessage', " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, "^0Shoma madarek khod ra be ^3" .. GetPlayerName(GetPlayerFromServerId(target)) ..  " ^0neshan dadid!")
							
							TriggerServerEvent('esx_showlicense:ShowTheLicense', GetPlayerServerId(PlayerId()), target)

						else

							TriggerEvent('chatMessage', " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, "^0Player mored nazar nazdik shoma nist")
						
						end

					else

						TriggerEvent('chatMessage', " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, "^0Shoma nemitavanid Madarek ra be khodetan neshan dahid")
			...
			TriggerEvent('chatMessage', " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, "^0Shoma dar ghesmat ID fagat mitavanid adad vared konid")
  ...
  function setUniform(job, playerPed)
	  ...
	  TriggerEvent('skinchanger:getSkin', function(skin)
		...
		return
		 ...
		 if job == 'sheriff_vest' or job == 'swat_wear' then
		SetPedArmour(playerPed, 98)
		end
		  if skin.sex == 0 then
			  ...
			  if Config.Uniforms[job].male ~= nil then
				  ...
				  print(Config.Uniforms[job].male)
  ...
  function OpenCloakroomMenu()
	  ...
	  local elements = {
		  { label = 'Lebas Shahr Vandi', value = 'citizen_wear' },
	  }

	
		--table.insert(elements, {label = "Police Outfit", value = grade .. '_wear'})
		--table.insert(elements, {label = "Police Outfit L", value = grade .. '_wearl'})
		--table.insert(elements, {label = "Jelighe Zed Golule", value = 'vest'})
	  ...
	  if ESX.GetPlayerData().job.ext == 'sheriff' then
		table.insert(elements, {label = ('Sheriff Outfit'), value = 'sheriff_wear_' .. grade})
		...
		table.insert(elements, {label = ('Sheriff Motor Outfit'), value = 'sheriff_wear_cycle'})
		table.insert(elements, {label = ('Sheriff Patrol Outfit'), value = 'sheriff_wear_patrol'})
		elseif ESX.GetPlayerData().job.ext == 'DEA' then
		--table.insert(elements, {label = "DEA Outfit", value = 'dea_wear'})
		table.insert(elements, {label = ('DEA Outfit'), value = 'dea_wear'})
		else
		table.insert(elements, {label = "Police Outfit", value = grade .. '_wear'})
		--table.insert(elements, {label = "Police Outfit L", value = grade .. '_wearl'})
	  ...
	  if grade == 'boss' then
		  table.insert(elements, {label = ('Lebas Chief'), value = 'boss_wear'})
	  end
	  ...
	  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	  {
		  ...
		  if
			...
			data.current.value == 'sheriff_vest' or
		    data.current.value == 'sheriff_wear_cycle' or
			 data.current.value == 'sheriff_wear_patrol' or
			data.current.value == 'dea_wear' 
		  ...
		  then
			  ...
			  if data.current.value == "sheriff_wear_" .. grade or data.current.value == "sheriff_wearl_" .. grade or data.current.value == "sheriff_vest" or data.current.value == "sheriff_wear_cycle" or data.current.value == "sheriff_wear_patrol" then
  ...
  function OpenArmoryMenu(station)
	...
	if Config.EnableArmoryManagement then
	  ...
	  for i=1, #Config.PoliceStations[station].AuthorizedWeapons.Shared, 1 do
		local weapon = Config.PoliceStations[station].AuthorizedWeapons.Shared[i]
  ...
  function OpenVehicleSpawnerMenu(station, partNum)
	  ...
	  ESX.UI.Menu.CloseAll()
		  ...
		  if ESX.GetPlayerData().job.ext == 'sheriff' then
			...
			table.insert(elements, { label = "Sheriff Cruiser", model = "sheriff"})
			table.insert(elements, { label = "Sheriff Highway", model = "sheriff2"})
			table.insert(elements, { label = "Sheriff Granger", model = "sheriff2rto"})
			table.insert(elements, { label = "Sheriff Motor", model = "admiralsheriff"})
		...
		--if ESX.GetPlayerData().job.ext == 'traffic' then
		  ...
		  if data.current.value == 'citizen_interaction' then
			  local elements = {
				...
				--   {label = "GSR - برسی تفنگ",			value = 'gsr_test'},
				  ...
				  {label = 'Sabeghe Keifari',      value = 'criminalrecords'},
			  }
			  ...
			  'default', GetCurrentResourceName(), 'citizen_interaction',
			  {
				  ...
				  if closestPlayer ~= -1 and closestDistance <= 3.0 then
					  ...
					  elseif action == 'jail_menu' then
						...
						local closestPlayer2, distance2 = ESX.Game.GetClosestPlayer()
                           if distance2 ~= -1 and distance2 <= 3 then
                            TriggerEvent('esx_criminalrecords:open', closestPlayer2)
                            else
                    ESX.ShowNotification('No players nearby')
					  ...
					  elseif action == 'body_search' then
						 ...
						 -- if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)),GetEntityCoords(GetPlayerPed(GetPlayerFromServerId(closestPlayer))))
						  TriggerServerEvent('persianpdmassage2', GetPlayerServerId(closestPlayer), _U('being_searched'))
					  ...
					  elseif action == 'handcuff' then
						  ...
						  if distance <= 2.0 then
							  TriggerServerEvent('koskholimkosmikhayimmadarjendeirs', target_id, playerheading, playerCoords, playerlocation)
						  else
					  ...
					  elseif action == 'uncuff' then
						  ...
						  local target_id = GetPlayerServerId(target)
						  if distance <= 2.0 then
							  TriggerServerEvent('esx_policejob:requestreleaseirs', target_id, playerheading, playerCoords, playerlocation)
						  else
  ...
  function OpenBodySearchMenu(player)
	  ...
	  ESX.TriggerServerCallback('esx:getOtherPlayerDataCard', function(data)
		  ...
		  local elements = {}
		  ESX.TriggerServerCallback('esx_policejob:getmoney', function(money)
   ...
   function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx:getOtherPlayerDataCard', function(data)
		...
		function(data, menu)
			...
			TriggerServerEvent('persianpdmassage2', GetPlayerServerId(player), _U('license_revoked', data.current.label))
  ...
  AddEventHandler('esx:setcallsign', function(sign)
		if PlayerData.job.name == "police" or PlayerData.job.name == "ambulance" or PlayerData.job.name == "government" or PlayerData.job.name == "cia" then
...
Citizen.CreateThread(function()
  ...
  AddEventHandler('esx_policejob:closecall', function()
	...
	RegisterCommand("setcall", function(source, args)
		if not tonumber(args[1]) then
			TriggerEvent('chat:addMessage', { color = { 255, 0, 0}, multiline = true, args = {" [ SYSTEM | PersianPixel ] ", "Syntax vared shode eshtebah ast"}})
			return
		end
			...
			if blip ~= nil then
				...
				TriggerEvent('chat:addMessage', { color = { 255, 0, 0}, multiline = true, args = {" [ SYSTEM | PersianPixel ] ", "Shoma be hich calli javab nadadid"}})
			end
		else
			TriggerEvent('chat:addMessage', { color = { 255, 0, 0}, multiline = true, args = {" [ SYSTEM | PersianPixel ] ", "Shoma police nistid"}})
		end
	end, false)
  ...
  RegisterNetEvent('esx_policejob:gohandcuffirs')
  AddEventHandler('esx_policejob:gohandcuffirs', function()
	  local playerPed = PlayerPedId()
  ...
  AddEventHandler('esx_policejob:unrestrain', function()
	  if IsHandcuffed then
		  local playerPed = PlayerPedId()
		  IsHandcuffed = false
           TriggerEvent('dp:changestatus',true)
...
-- 				else
-- 					TriggerEvent('chat:addMessage', { color = {255, 0, 0}, multiline = true, args = {" [ SYSTEM | PersianPixel ] ", "System hazf mashin be moshkel barkhord be developer etelaa dahid!"}})
-- 				end
-- 			else
...
-- 		  else
-- 			TriggerEvent('chat:addMessage', { color = {255, 0, 0}, multiline = true, args = {" [ SYSTEM | PersianPixel ] ", "In mashin vojod naddarad lotfan be admin etelaa dahid"}})
-- 		  end
...
--   end)
  ...
  AddEventHandler('esx_policejob:getarrested', function(playerheading, playercoords, playerlocation)
	if ESX.GetPlayerData()['HandCuffed'] ~= 1 then
	  ...
	  TriggerServerEvent('sedahayeajibpersianpixelxd', 5.0, 'cuff', 1.0)
	  Citizen.Wait(250)
	  ...
	  IsHandcuffed = true
	  TriggerEvent('dp:changestatus',false)
	  TriggerEvent('esx_policejob:gohandcuffirs')
			  ...
			  if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'police' then
				...
				elseif CurrentAction == 'menu_helicopter_spawner' then
				  ...
				  elseif CurrentAction == 'menu_boss_actions' then
					  ESX.UI.Menu.CloseAll()
					  TriggerEvent('esx_society:openbossirs', 'police', function(data, menu)
						  menu.close()
						  CurrentAction     = 'menu_boss_actions'
						  CurrentActionMsg  = _U('open_bossmenu')
						  CurrentActionData = {}
...
--   end
  ...
  RegisterCommand('vestpd', function(source)
	if PlayerData.job.name == "police" then
	   if ESX.GetPlayerData().job.ext == 'detective' then
 ...
 RegisterCommand('maskpd', function(source)
	if PlayerData.job.name == "police" then
	   if ESX.GetPlayerData().job.ext == 'detective' then
