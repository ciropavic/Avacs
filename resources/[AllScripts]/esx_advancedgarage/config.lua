...
Config.DeleteMarker = {
	...
	x = 3.5, y = 3.5, z = 0.5  -- Big Size Circle
}
...
Config.CarGarages = {
	Garage_CentralLS = {
		...
		SpawnPoint = { x = 224.11, y = -796.45, z = 30.67, h = 251.94 ,x2 = 234.56, y2 = -800.21, z2 = 29.91, h2 = 67.43,x3 = 228.34, y3 = -789.3, z3 = 30.1, h3 = 247.49,x4 = 237.57, y4 = -792.54, z4 = 29.94, h4 = 68.42},
		DeletePoint = { x = 223.797, y = -760.415, z = 29.646 }
	},
	Garage_Shahr2 = {
		GaragePoint = { x = 44.11, y = -842.96, z = 30.1 },
		SpawnPoint = { x = 54.04, y = -863.44, z = 30.24, h = 339.56 ,x2 = 59.69, y2 = -849.03, z2 = 30.47, h2 = 158.21,x3 = 35.22, y3 = -857.46, z3 = 30.27, h3 = 339.79,x4 = 37.53, y4 = -840.81, z4 = 30.55, h4 = 159.4 },
		DeletePoint = { x = 36.34, y = -896.19, z = 29.1 }
	},
	Garage_Shahr3 = {
		...
		DeletePoint = { x = -310.4, y = -887.64, z = 30.1 }
	},
	Garage_Shahr4 = {
		GaragePoint = { x = 876.5, y = -78.91, z = 77.8 },
		SpawnPoint = { x = 886.69, y = -63.06, z = 78.42, h = 238.2 ,x2 = 889.43, y2 = -60.36, z2 = 78.42, h2 = 236.54,x3 = 898.23, y3 = -74.27, z3 = 78.42, h3 = 57.83,x4 = 899.73, y4 = -71.36, z4 = 78.42, h4 = 56.85 },
		DeletePoint = { x = 905.29, y = -52.71, z = 77.8 }
	},
	Garage_Shahr5 = {
		GaragePoint = { x = 596.58, y = 91.4, z = 92.1 },
		SpawnPoint = { x = 599.58, y = 98.13, z = 92.56, h = 248.54 ,x2 = 600.79, y2 = 102.01, z2 = 92.56, h2 = 250.97 ,x3 = 609.17, y3 = 107.59, z3 = 92.52, h3 = 69.05,x4 = 610.7, y4 = 111.23, z4 = 92.58, h4 = 69.64 },
		DeletePoint = { x = 619.66, y = 97.84, z = 91.2 }
	},
	Garage_Shahr6 = {
		GaragePoint = { x = 100.6, y = -1073.62, z = 28.3 },
		SpawnPoint = { x = 105.83, y = -1062.91, z = 28.86, h = 245.49 ,x2 = 108.58, y2 = -1059.62, z2 = 28.86, h2 = 247.38 ,x3 = 108.04, y3 = -1079.1, z3 = 28.84, h3 = 339.2,x4 = 111.51, y4 = -1080.43, z4 = 28.84, h4 = 338.87 },
		DeletePoint = { x = 127.26, y = -1062.47, z = 28.2 }
	},
	Garage_Sandy = {
...
Config.CarPounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 437.32, y = -979.8, z = 29.69 },
