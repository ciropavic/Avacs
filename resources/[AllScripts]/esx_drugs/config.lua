...
Config.Peds = {
	...
	Drug =		{ ped = GetHashKey("a_m_o_soucent_03"), x = -1170.37, y = -1570.6, z = 3.7, h = 124.63 },
}
...
Config.Locations = {
	...
	{ x = 3801.48, y = 4441.00, z = 3.21}, -- process tokhm cocacine be cocaine
	{ x = 2329.02, y = 2571.29, z = 45.75}, -- tabdil hashish(cannabis) be marijuana
	{ x = 1443.47, y = 6333.11, z = 22.98}, -- tabdil ephedra be ephedrine
