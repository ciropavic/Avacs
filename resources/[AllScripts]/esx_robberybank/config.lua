...
Banks = {
	["fleeca"] = {
		...
		reward = math.random(800000,1000000), -- the random range of amount of money you will get for robbery this site
		nameofbank = "Fleeca Bank", --Visual Name that will be the site
		lastrobbed = 3800, -- DONT TOUCH THIS variable used to make a delay to robb other time
	...
	["blainecounty"] = {
		...
		reward = math.random(1000000,1200000),
	...
	["PrincipalBank"] = {
		...
		reward = math.random(1800000,2300000),
