...
RegisterServerEvent('amirazjawaherimrluabestfriend')
AddEventHandler('amirazjawaherimrluabestfriend', function()
...
AddEventHandler('lester:vendita', function()
    ...
    local items = xPlayer.getInventoryItem('jewels')
	if items.count < 35 then exports.bansystem.bancheater(_source,'Try To Add Jewels') end
