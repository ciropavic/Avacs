  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'boss_actions' then
        TriggerEvent('esx_society:openbossirs', 'mechanic', function(data, menu)
          menu.close()
        end)
      end
            ...
            if amount == nil or amount < 0 then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ESX.ShowNotification(_U('no_players_nearby'))
				        ...
				        menu.close()
                TriggerServerEvent('esx_bishirmikhorilling:sendBill', GetPlayerServerId(closestPlayer), 'society_mechanic', _U('mechanic'), amount)
              end
            end
          end,
        function(data, menu)
