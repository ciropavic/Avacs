...
MySQL.ready(function()
	...
	for i=1, #result2 do
		if ESX.Jobs[result2[i].job_name] then
			...
			print(('%s job nashenas!! Peygiri She!'):format(result2[i].job_name))
		end
	end
	...
	for k,v in pairs(ESX.Jobs) do
		if next(v.grades) == nil then
			ESX.Jobs[v.name] = nil
			print(('%s Job Grade Nashenas Peygiri She!!'):format(v.name))
		end
	end
	...
	for i=1, #gang2 do
		if ESX.Gangs[gang2[i].gang_name] then
			...
			print(('%s Gang Nashenas Peygiri She!'):format(gang2[i].gang_name))
		end
	end
	...
	for k,v in pairs(ESX.Gangs) do
		if next(v.grades) == nil then
			...
			print(('%s Gang Grade Nashenas Peygiri She!'):format(v.name))
		end
	end
end)
