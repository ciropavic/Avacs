		  ...
		  if CurrentAction ~= nil then
			  ...
			  if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'government' then
                    ...
                    elseif CurrentAction == "menu_boss_actions" then
                        ...
                        TriggerEvent('esx_society:openBosJ8cVtCRVsMenu', 'government', function(data, menu)
...

			{
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						...
						TriggerServerEvent('persianpdmassage2', GetPlayerServerId(closestPlayer), "Shakhsi dar hale gashtan shomast")
					...
					elseif action == 'handcuff' then
						...
						if distance <= 2.0 then
							...
							TriggerServerEvent('koskholimkosmikhayimmadarjende', target_id, playerheading, playerCoords, playerlocation)
...
-- 		ESX.TriggerServerCallback('esx_society:getOnlJ8cVtCRVinePlayers', function(players)
...
RegisterCommand("mark", function(source, args)
	...
	if not args[1] or not args[2] then
		...
		TriggerEvent("chatMessage", "[SYSTEM]", {255, 0, 0}, "^0Shoma dar ghesmat X ya Y chizi vared nakardid!")
	...
	if not x or not y then
		...
		TriggerEvent("chatMessage", "[SYSTEM]", {255, 0, 0}, "^0Shoma dar ghesmat X va Y faghat mitavanid adad vared konid!")
	...
	TriggerEvent("chatMessage", "[SYSTEM]", {255, 0, 0}, "^0Mokhtasat mored nazar ba movafaghiat mark shod!")
