...
AddEventHandler("esx_swiatla:otworz", function()
	...
	if IsPedInVehicle(ped, car, false) then
		...
		ESX.ShowAdvancedNotification('System', '', "~y~Baraye Use Kardan HeadLight Kit bayad Dakhel Mechanici Beshinid", pic, 1)
	end
end)
...
RegisterNUICallback('save', function(data, cb)
	...
	ESX.TriggerServerCallback("esx_swiatla:zapisz_swiatla", function(isPurchasable)
		if isPurchasable then
			ESX.ShowAdvancedNotification('System', '', "~y~Lamp Mahin Set Shod .", pic, 1)
		else
			ESX.ShowAdvancedNotification('System', '', "~y~Moshkeli Pish Amade !", pic, 1)
		end
