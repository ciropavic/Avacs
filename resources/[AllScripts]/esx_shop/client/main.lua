...
Locations = {
    ...
    [21] = {
        ["shelfs"] = {
            {["x"] = 190.48, ["y"] = -888.6, ["z"] = 30.71, ["value"] = "checkout"},
            {["x"] = 189.99, ["y"] = -900.51, ["z"] = 30.71, ["value"] = "drinks"},
            {["x"] = 190.69, ["y"] = -892.22, ["z"] = 30.71, ["value"] = "snacks"},
            {["x"] = 186.52, ["y"] = -894.51, ["z"] = 30.71, ["value"] = "readymeal"},
            {["x"] = 189.82, ["y"] = -890.47, ["z"] = 30.71, ["value"] = "diverse"},
        },
        ["blip"] = {
            ["x"] = 192.51, ["y"] = -890.27, ["z"] = 30.71
        },
        ["cashier"] = {
            ["x"] = 188.86, ["y"] = -888.11, ["z"] = 29.71, ["h"] = 248.79
        },
        ["boss"] = {
            coords = {x = 188.07, y = -890.05, z = 30.71 },
            owner = false
        },
    },
}
...
AddEventHandler("esx:playerLoaded",function()
    Wait(3500)
    ESX.TriggerServerCallback('esx_shop:CheckOwner', function(Owner)
        if Owner then
            local Coords = vector3(45.91, -1749.08, 29.62)
            ...
            BeginTextCommandSetBlipName("OmdeBlip")
            AddTextEntry("OmdeBlip",'Omde Forosh')
