mumbleConfig = {
    voiceModes = {
        {2.5, "Aroum"}, -- Whisper speech distance in gta distance units
        {8, "Mamoli"}, -- Normal speech distance in gta distance units
        {20, "Boland"}, -- Shout speech distance in gta distance units
    },
