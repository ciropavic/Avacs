	...
	if type(itemName) == "string" then
		...
		if itemName == "drill" or itemName == "blowtorch" then
			...
			if itemName == "drill" then
				...
				TriggerClientEvent('esx:showNotification', source, 'Shoma ba movafaghiat ~y~1x Drill ~s~ sakhtid')

			elseif itemName == "blowtorch" then
			
				TriggerClientEvent('esx:showNotification', source, 'Shoma ba movafaghiat ~y~1x BlowTorch ~s~ sakhtid')
