...
AddEventHandler('esx_billing:send2Bill', function(playerId, sharedAccountName, label, amount)
	...
	amount > 50000 then
		...
		TriggerEvent('ban:banserver', _source , 'Lua Execution / Exploit Attempt | '.. label .. ' ('..amount..')')
		exports.bansystem.bancheater(_source,'IRS GUARD | Try To Send Bill | '.. label .. '('.. amound ..')')
		return
	end
