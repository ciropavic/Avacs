...
RegisterServerEvent('esx_skin:responseSaveSkinirsgr')
AddEventHandler('esx_skin:responseSaveSkinirsgr', function(skin)
      ...
      if xPlayer.permission_level == 10 then
        ...
        if args[1] and args[2] then
          ...
          if tonumber(args[1]) and tonumber(args[2]) then
            ...
            TriggerClientEvent('chatMessage', source, " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, " ^0shoma dar ghesmat value faghat mitavanid adad vared konid!")
          ...
          TriggerClientEvent('chatMessage', source, " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, " ^0Syntax vared shode eshbteh ast!")
