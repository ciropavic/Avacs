...
Radio.Commands = {
        ...
        Handler = function(src, args, raw)
            if Radio.Has then
                if not Radio.On then
                    TriggerEvent('chat:addMessage', {color = { 255, 0, 0}, multiline = true ,args = {" [ SYSTEM | PersianPixel ] ", "^0Radio Shoma ^2Khamoush ^0Ast "}})
                    return
                end
                ...
                if args[1] then
                    ...
                    if newFrequency then
                        ...
                        TriggerEvent('chat:addMessage', {color = { 255, 0, 0}, multiline = true ,args = {" [ SYSTEM | PersianPixel ] ", "^0Shoma dar ghesmat ^2freq ^0 faghat mitavanid ^1adad ^0 vared konid!"}})
                    end
                else
                    TriggerEvent('chat:addMessage', {color = { 255, 0, 0}, multiline = true ,args = {" [ SYSTEM | PersianPixel ] ", "^0Shoma dar ghesmat ^2freq ^0 chizi vared nakardid!"}})
                end                    
            end
        end,
    },
    {
        ...
        Handler = function(src, args, raw)
            if Radio.Has then
                if not Radio.On then
                    TriggerEvent('chat:addMessage', {color = { 255, 0, 0}, multiline = true ,args = {" [ SYSTEM | PersianPixel ] ", "^0Radio shoma ^2roshan ^0nist!"}})
                    return
                end

                if radioConfig.Frequency.Current then
                    TriggerEvent('chat:addMessage', {color = { 255, 0, 0}, multiline = true ,args = {" [ SYSTEM | PersianPixel ] ", "^0Freq radio shoma: ^2" .. radioConfig.Frequency.Current}})
                else
                    TriggerEvent('chat:addMessage', {color = { 255, 0, 0}, multiline = true ,args = {" [ SYSTEM | PersianPixel ] ", "^0Radio shoma hich ^2freqi ^0nadarad!"}})
                end
            ...
            if Radio.Has then
                ...
                if args[1] then
                    if string.lower(args[1]) == "true" then
                        ...
                        TriggerEvent('chat:addMessage', {color = { 255, 0, 0}, multiline = true ,args = {" [ SYSTEM | PersianPixel ] ", "^0Shoma ba movafaghiat Radio Click khod ra ^1mute ^0kardid!"}})
                    elseif string.lower(args[1]) == "false" then
                        exports["mumble_voip"]:MuteRadioClick(false)
                        TriggerEvent('chat:addMessage', {color = { 255, 0, 0}, multiline = true ,args = {" [ SYSTEM | PersianPixel ] ", "^0Shoma ba movafaghiat Radio Click khod ra ^2unmute ^0kardid!"}})
                    else
                        TriggerEvent('chat:addMessage', {color = { 255, 0, 0}, multiline = true ,args = {" [ SYSTEM | PersianPixel ] ", "^0Shoma dar ghesmat satate ^2mute ^0 faghat mitavanid ^1true ya false ^0 vared konid!"}})
                    end
                else
                    TriggerEvent('chat:addMessage', {color = { 255, 0, 0}, multiline = true ,args = {" [ SYSTEM | PersianPixel ] ", "^0Shoma dar state ^2mute ^0 chizi vared nakardid!"}})
                end
