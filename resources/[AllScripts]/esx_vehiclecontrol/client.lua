		...
		if GetVehicleDoorLockStatus(vehicle) == 2 then
			...
			TriggerEvent("mythic_progbar:client:progress", {
				...
				if not status then
					...
					if number % 2 == 0 then
						HiJack(vehicle)
						TriggerEvent("chatMessage", " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, "^0Mashin ba movafaghiat ^1picklock ^0shod!")
						TriggerServerEvent('esx_vehiclecontrol:syncAlarm', NetId, false)
					else
						TriggerEvent("chatMessage", " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, "^0PickLock shoma ^1shekast!")
			...
			TriggerEvent("chatMessage", " [ SYSTEM | PersianPixel ] ", {255, 0, 0}, "^0Dare mashin mored nazar ghofl nist!")
		end
