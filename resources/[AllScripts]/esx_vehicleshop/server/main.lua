...
RegisterServerEvent('esx_vehicleshop:setVehicleirsOwned')
AddEventHandler('esx_vehicleshop:setVehicleirsOwned', function (vehicleProps, society)
	...
	if xPlayer.money >= vehicleData.price then
	    if found then
		    ...
		    print(('esx_vehicleshop: ID: %s attempted to inject vehicle!'):format(xPlayer.source))
		end
	else
		TriggerClientEvent('esx:deleteVehicle', _source)
		print(('esx_vehicleshop: ID: %s attempted to Free Vehicle!'):format(xPlayer.source))
	end
end)

RegisterServerEvent('esx_vehicleshop:setVehicleGangirs')
AddEventHandler('esx_vehicleshop:setVehicleGangirs', function (vehicleProps, society)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_vehicleshop:setVehicleirsOwnedPlayerId')
AddEventHandler('esx_vehicleshop:setVehicleirsOwnedPlayerId', function (playerId, vehicleProps)
	local _source = source
	...
	if xPlayerSource.money >= vehicleData.price then
	    if found then
		    ...
		    print(('esx_vehicleshop: %s attempted to inject vehicle!'):format(xPlayerSource.source))
		end
	else
		print(('esx_vehicleshop: ID: %s attempted to Free Vehicle!'):format(xPlayerSource.source))
	end

end)

RegisterServerEvent('esx_vehicleshop:AdminsetVehicleirsOwnedPlayerId')
AddEventHandler('esx_vehicleshop:AdminsetVehicleirsOwnedPlayerId', function (playerId, vehicleProps)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(playerId)
...
RegisterServerEvent('esx_vehicleshop:setVehicleirsOwnedSociety')
AddEventHandler('esx_vehicleshop:setVehicleirsOwnedSociety', function (society, vehicleProps)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
