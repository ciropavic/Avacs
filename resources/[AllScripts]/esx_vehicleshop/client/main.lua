...
function OpenShopMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		local elements = {}
		if ESX.PlayerData.gang.label == 'gang' then
			elements = {
				
				{label = 'Kharide in Mashin baraye Khodet', value = 'buyformyself'},
				{label = 'Kharide in Mashin baraye Gang', value = 'buyforgang'},
			}
		else
			elements = {
					...
					if hasEnoughMoney then
						...
						ESX.Game.SpawnVehicle(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
							...
							if Config.EnableOwnedVehicles then
								TriggerServerEvent('esx_vehicleshop:setVehicleirsOwned', vehicleProps)
							end
					...
					if hasEnoughMoney then
						...
						ESX.Game.SpawnVehicle(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
							...
							elseif data2.current.value == 'buyforgang' then
								TriggerServerEvent('esx_vehicleshop:setVehicleirsOwned', vehicleProps, ESX.PlayerData.gang.name)
