...
function OpenBuyLicenseMenu(zone)
    ...
    ESX.UI.Menu.Open('question', GetCurrentResourceName(), 'not_license',
    {
        title      = 'Ekhtarie',
        align    = 'center',
        question = "Shoma Bayad Bayad License Gun Khod ra Ba Morajee be Site FireArms Divishion va Por Kardan Form Quiz Bedast Avarid va Baraye Quit Kafist Command /tabui ra Vared Konid .",
        elements = {
            {label = 'Close', value = 'yes'},
        }
    }, function(data, menu)
