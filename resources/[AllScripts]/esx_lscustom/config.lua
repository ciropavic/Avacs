...
Config.Zones = {
	...
	ls5 = {
		Pos   = { x = 1173.69, y = 2640.41, z = 37.77},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modXenon = {
		...
		parent = 'cosmetics',
		modType = 22,
		modHeadlightR = _U('Red'),
		modHeadlightG = _U('Green'),
		modHeadlightW = _U('White'),
		modHeadlightDB = _U('Dark Blue'),
		modHeadlightLB = _U('Light blue'),
		modHeadlightT = _U('Turquoise'),
		modHeadlightDY = _U('Dark Yellow'),
		modHeadlightBO = _U('Bright Orange'),
		modHeadlightDO = _U('Dark Orange'),
		modHeadlightLP = _U('Light pink'),
		modHeadlightDP = _U('Dark pink'),
		modHeadlightLPr = _U('Light purple'),
		modHeadlightDPr = _U('Dark purple'),
		modHeadlightX = _U('Xenon'),
		price = 0.5
	},
	bodyparts = {
		label = _U('bodyparts'),
