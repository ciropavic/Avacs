...
UnlockHouse = function(house)
  ...
  elseif Config.UsingESX and Config.UsingESXMenu then
    ...
    exports["3dme"]:AME("Shoro mikone be baz kardan ghofl dare khane")
...
LockHouse = function(house)
  ...
  inProgressAction = true
  exports["3dme"]:AME("Shoro mikone be ghofl kardan dare khane")
  TriggerEvent("mythic_progbar:client:progress", {
    name = "lock_house",
    duration = 3000,
  ...
  if Config.UsingESX then
    if not Config.UsingDiscInventory then
      ESX.TriggerServerCallback('Allhousing:GetInventory', function(inventory)
        exports["3dme"]:AME("Safe ro baaz mikone")
...
LeaveHouse = function(d, data)
  ...
  if data and data.force then
    ...
    return
      ...
      inProgressAction = true
      exports["3dme"]:AME("Shoro mikone be baz kardan dar va sai mikone az khane kharej she")
      TriggerEvent("mythic_progbar:client:progress", {
        name = "leave_house",
        duration = 3000,
...
EnterHouse = function(d,visiting)
  ...
  if d.Unlocked or not d.Owned then
    ...
    inProgressAction = true
    exports["3dme"]:AME("Shoro mikone be baz kardan dar va sai mikone vared khane she")
    TriggerEvent("mythic_progbar:client:progress", {
      name = "enter_house",
      duration = 3000,
    ...
    exports["3dme"]:AME("Sai mikone vared khane beshe vali dar baz nemishe")
    ESX.ShowNotification("~h~Dare khane ghofl ast nemitavanid vared shavid!")
  end
end
