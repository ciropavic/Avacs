...
function getIdentifierByPhoneNumber(phone_number)
	local result = MySQL.Sync.fetchAll("SELECT identifier FROM users WHERE users.phone_number = @phone_number", {
...
RegisterServerEvent('gcPhone:sendMessageirs')
AddEventHandler('gcPhone:sendMessageirs', function(phoneNumber, message)
	local sourcePlayer = tonumber(source)
	local identifier = getPlayerID(source)
