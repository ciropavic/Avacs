...
-- Dumping database structure for irspring
DROP DATABASE IF EXISTS `irspring`;
CREATE DATABASE IF NOT EXISTS `irspring` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `irspring`;

-- Dumping structure for table irspring.addon_account
DROP TABLE IF EXISTS `addon_account`;
CREATE TABLE IF NOT EXISTS `addon_account` (
  `name` varchar(60) COLLATE utf8mb3_persian_ci NOT NULL,
  `label` varchar(100) COLLATE utf8mb3_persian_ci NOT NULL,
  `shared` int(11) NOT NULL,
  PRIMARY KEY (`name`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.addon_account: ~21 rows (approximately)
...
-- Dumping structure for table irspring.addon_account_data
DROP TABLE IF EXISTS `addon_account_data`;
CREATE TABLE IF NOT EXISTS `addon_account_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account_name` varchar(100) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `money` int(11) NOT NULL,
  `owner` varchar(100) COLLATE utf8mb3_persian_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=21459 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.addon_account_data: ~38 rows (approximately)
...
-- Dumping structure for table irspring.addon_inventory
...
-- Dumping data for table irspring.addon_inventory: ~36 rows (approximately)
...
-- Dumping structure for table irspring.addon_inventory_items
DROP TABLE IF EXISTS `addon_inventory_items`;
CREATE TABLE IF NOT EXISTS `addon_inventory_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `inventory_name` varchar(100) COLLATE utf8mb3_persian_ci NOT NULL,
  `name` varchar(100) COLLATE utf8mb3_persian_ci NOT NULL,
  `count` int(11) NOT NULL,
  `owner` varchar(60) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=4092 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.addon_inventory_items: ~241 rows (approximately)
...
-- Dumping structure for table irspring.adminjaillog
...
-- Dumping data for table irspring.adminjaillog: ~151 rows (approximately)
...
-- Dumping structure for table irspring.allhousing
...
-- Dumping data for table irspring.allhousing: ~10 rows (approximately)
...
-- Dumping structure for table irspring.anticheat
...
-- Dumping data for table irspring.anticheat: ~0 rows (approximately)
/*!40000 ALTER TABLE `anticheat` DISABLE KEYS */;
/*!40000 ALTER TABLE `anticheat` ENABLE KEYS */;

-- Dumping structure for table irspring.arrests_list
...
-- Dumping data for table irspring.arrests_list: ~0 rows (approximately)
/*!40000 ALTER TABLE `arrests_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `arrests_list` ENABLE KEYS */;

-- Dumping structure for table irspring.baninfo
...
-- Dumping data for table irspring.baninfo: ~8 rows (approximately)
...
-- Dumping structure for table irspring.banlist
...
-- Dumping data for table irspring.banlist: ~1 rows (approximately)
...
-- Dumping structure for table irspring.banlisthistory
...
CREATE TABLE IF NOT EXISTS `banlisthistory` (
  ...
  KEY `license` (`license`)
) ENGINE=InnoDB AUTO_INCREMENT=1640 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

-- Dumping data for table irspring.banlisthistory: ~1 rows (approximately)
...
-- Dumping structure for table irspring.billing
DROP TABLE IF EXISTS `billing`;
CREATE TABLE IF NOT EXISTS `billing` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `identifier` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `sender` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `target_type` varchar(50) COLLATE utf8mb3_persian_ci NOT NULL,
  `target` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `label` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `amount` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `identifier` (`identifier`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1306 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.billing: ~0 rows (approximately)
/*!40000 ALTER TABLE `billing` DISABLE KEYS */;
/*!40000 ALTER TABLE `billing` ENABLE KEYS */;

-- Dumping structure for table irspring.blackmarket
DROP TABLE IF EXISTS `blackmarket`;
CREATE TABLE IF NOT EXISTS `blackmarket` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store` varchar(100) COLLATE utf8mb3_persian_ci NOT NULL,
  `item` varchar(100) COLLATE utf8mb3_persian_ci NOT NULL,
  `price` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.blackmarket: ~18 rows (approximately)
...
-- Dumping structure for table irspring.bolos_list
...
-- Dumping data for table irspring.bolos_list: ~0 rows (approximately)
/*!40000 ALTER TABLE `bolos_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `bolos_list` ENABLE KEYS */;

-- Dumping structure for table irspring.capture
DROP TABLE IF EXISTS `capture`;
CREATE TABLE IF NOT EXISTS `capture` (
  `name` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `reward` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `coordinate` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `handeler` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL DEFAULT 'Daltons'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.capture: ~3 rows (approximately)
...
-- Dumping structure for table irspring.cardealer_vehicles
DROP TABLE IF EXISTS `cardealer_vehicles`;
CREATE TABLE IF NOT EXISTS `cardealer_vehicles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vehicle` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `price` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.cardealer_vehicles: ~0 rows (approximately)
/*!40000 ALTER TABLE `cardealer_vehicles` DISABLE KEYS */;
/*!40000 ALTER TABLE `cardealer_vehicles` ENABLE KEYS */;

-- Dumping structure for table irspring.car_parking
...
-- Dumping data for table irspring.car_parking: ~0 rows (approximately)
...
-- Dumping structure for table irspring.code
...
-- Dumping data for table irspring.code: ~6 rows (approximately)
...
-- Dumping structure for table irspring.datastore
...
-- Dumping data for table irspring.datastore: ~30 rows (approximately)
...
-- Dumping structure for table irspring.datastore_data
DROP TABLE IF EXISTS `datastore_data`;
CREATE TABLE IF NOT EXISTS `datastore_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(60) COLLATE utf8mb3_persian_ci NOT NULL,
  `owner` varchar(60) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `data` longtext COLLATE utf8mb3_persian_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `index_datastore_data_name_owner` (`name`,`owner`) USING BTREE,
  KEY `index_datastore_data_name` (`name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=52457 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.datastore_data: ~76 rows (approximately)
...
-- Dumping structure for table irspring.denied
...
-- Dumping data for table irspring.denied: 0 rows
/*!40000 ALTER TABLE `denied` DISABLE KEYS */;
/*!40000 ALTER TABLE `denied` ENABLE KEYS */;

-- Dumping structure for table irspring.divisions
...
-- Dumping data for table irspring.divisions: ~2 rows (approximately)
...
-- Dumping structure for table irspring.division_grades
...
-- Dumping data for table irspring.division_grades: ~2 rows (approximately)
...
-- Dumping structure for table irspring.dpkeybinds
...
-- Dumping data for table irspring.dpkeybinds: ~9 rows (approximately)
...
-- Dumping structure for table irspring.fines
...
-- Dumping data for table irspring.fines: ~3 rows (approximately)
...
-- Dumping structure for table irspring.fine_types
DROP TABLE IF EXISTS `fine_types`;
CREATE TABLE IF NOT EXISTS `fine_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `label` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `amount` int(11) DEFAULT NULL,
  `category` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.fine_types: ~54 rows (approximately)
...
-- Dumping structure for table irspring.gangs
DROP TABLE IF EXISTS `gangs`;
CREATE TABLE IF NOT EXISTS `gangs` (
  `name` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `label` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.gangs: ~1 rows (approximately)
/*!40000 ALTER TABLE `gangs` DISABLE KEYS */;
INSERT INTO `gangs` (`name`, `label`) VALUES
	('nogang', 'nogang');
/*!40000 ALTER TABLE `gangs` ENABLE KEYS */;

-- Dumping structure for table irspring.gangs_data
DROP TABLE IF EXISTS `gangs_data`;
CREATE TABLE IF NOT EXISTS `gangs_data` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `gang_name` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `blip` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `armory` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `locker` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `boss` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `vehicles` longtext COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `veh` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `vehprop` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `vehdel` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `vehspawn` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `register_time` date DEFAULT NULL,
  `expire_time` date DEFAULT NULL,
  `search` tinyint(4) DEFAULT NULL,
  `bulletproof` int(100) DEFAULT 0,
  `webhook` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `slot` int(255) DEFAULT 10,
  `logpower` int(11) DEFAULT 0,
  `armoryperm` int(11) DEFAULT 6,
  `icon` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT 'http://uupload.ir/files/1j24_gang.png',
  `invperm` int(11) DEFAULT 6,
  `gangsblip` int(11) DEFAULT 0,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.gangs_data: ~0 rows (approximately)
/*!40000 ALTER TABLE `gangs_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `gangs_data` ENABLE KEYS */;

-- Dumping structure for table irspring.gang_account
...
-- Dumping data for table irspring.gang_account: ~0 rows (approximately)
/*!40000 ALTER TABLE `gang_account` DISABLE KEYS */;
/*!40000 ALTER TABLE `gang_account` ENABLE KEYS */;

-- Dumping structure for table irspring.gang_account_data
...
CREATE TABLE IF NOT EXISTS `gang_account_data` (
  ...
  `owner` varchar(254) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `token` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `armoryaccess` int(64) NOT NULL DEFAULT 1,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=382 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.gang_account_data: ~0 rows (approximately)
/*!40000 ALTER TABLE `gang_account_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `gang_account_data` ENABLE KEYS */;

-- Dumping structure for table irspring.gang_grades
...
CREATE TABLE IF NOT EXISTS `gang_grades` (
  ...
  `skin_male` longtext COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `skin_female` longtext COLLATE utf8mb3_persian_ci DEFAULT NULL,
  PRIMARY KEY (`ID`) USING BTREE,
  KEY `skin_male` (`skin_male`(255)),
  KEY `skin_female` (`skin_female`(255)),
  KEY `gang_name` (`gang_name`),
  KEY `grade` (`grade`)
) ENGINE=InnoDB AUTO_INCREMENT=2288 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.gang_grades: ~1 rows (approximately)
...
-- Dumping structure for table irspring.gas_station_balance
...
-- Dumping data for table irspring.gas_station_balance: ~0 rows (approximately)
/*!40000 ALTER TABLE `gas_station_balance` DISABLE KEYS */;
/*!40000 ALTER TABLE `gas_station_balance` ENABLE KEYS */;

-- Dumping structure for table irspring.gas_station_business
...
-- Dumping data for table irspring.gas_station_business: ~0 rows (approximately)
/*!40000 ALTER TABLE `gas_station_business` DISABLE KEYS */;
/*!40000 ALTER TABLE `gas_station_business` ENABLE KEYS */;

-- Dumping structure for table irspring.gas_station_jobs
...
-- Dumping data for table irspring.gas_station_jobs: ~0 rows (approximately)
/*!40000 ALTER TABLE `gas_station_jobs` DISABLE KEYS */;
/*!40000 ALTER TABLE `gas_station_jobs` ENABLE KEYS */;

-- Dumping structure for table irspring.granted
...
-- Dumping data for table irspring.granted: 0 rows
/*!40000 ALTER TABLE `granted` DISABLE KEYS */;
/*!40000 ALTER TABLE `granted` ENABLE KEYS */;

-- Dumping structure for table irspring.items
DROP TABLE IF EXISTS `items`;
CREATE TABLE IF NOT EXISTS `items` (
  `name` varchar(50) COLLATE utf8mb3_bin NOT NULL,
  `label` varchar(255) COLLATE utf8mb3_bin NOT NULL,
...
-- Dumping data for table irspring.items: ~232 rows (approximately)
...
-- Dumping structure for table irspring.jobs
...
-- Dumping data for table irspring.jobs: ~27 rows (approximately)
...
-- Dumping structure for table irspring.job_grades
DROP TABLE IF EXISTS `job_grades`;
CREATE TABLE IF NOT EXISTS `job_grades` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `job_name` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL,
  `grade` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb3_bin NOT NULL,
  `label` varchar(255) COLLATE utf8mb3_bin NOT NULL,
  `salary` int(11) NOT NULL,
  `skin_male` longtext COLLATE utf8mb3_bin NOT NULL,
  `skin_female` longtext COLLATE utf8mb3_bin NOT NULL,
  PRIMARY KEY (`id`),
  KEY `skin_male` (`skin_male`(255)),
  KEY `skin_female` (`skin_female`(255))
) ENGINE=InnoDB AUTO_INCREMENT=146 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.job_grades: ~124 rows (approximately)
...
-- Dumping structure for table irspring.jsfour_cardetails
...
-- Dumping data for table irspring.jsfour_cardetails: ~1 rows (approximately)
...
-- Dumping structure for table irspring.jsfour_criminalrecord
...
-- Dumping data for table irspring.jsfour_criminalrecord: ~0 rows (approximately)
/*!40000 ALTER TABLE `jsfour_criminalrecord` DISABLE KEYS */;
/*!40000 ALTER TABLE `jsfour_criminalrecord` ENABLE KEYS */;

-- Dumping structure for table irspring.jsfour_criminaluserinfo
...
-- Dumping data for table irspring.jsfour_criminaluserinfo: ~0 rows (approximately)
/*!40000 ALTER TABLE `jsfour_criminaluserinfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `jsfour_criminaluserinfo` ENABLE KEYS */;

-- Dumping structure for table irspring.jsfour_efterlysningar
...
-- Dumping data for table irspring.jsfour_efterlysningar: ~0 rows (approximately)
/*!40000 ALTER TABLE `jsfour_efterlysningar` DISABLE KEYS */;
/*!40000 ALTER TABLE `jsfour_efterlysningar` ENABLE KEYS */;

-- Dumping structure for table irspring.jsfour_incidents
...
-- Dumping data for table irspring.jsfour_incidents: ~0 rows (approximately)
/*!40000 ALTER TABLE `jsfour_incidents` DISABLE KEYS */;
/*!40000 ALTER TABLE `jsfour_incidents` ENABLE KEYS */;

-- Dumping structure for table irspring.jsfour_logs
...
-- Dumping data for table irspring.jsfour_logs: ~0 rows (approximately)
/*!40000 ALTER TABLE `jsfour_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `jsfour_logs` ENABLE KEYS */;

-- Dumping structure for table irspring.licenses
DROP TABLE IF EXISTS `licenses`;
CREATE TABLE IF NOT EXISTS `licenses` (
  `type` varchar(60) COLLATE utf8mb3_persian_ci NOT NULL,
  `label` varchar(60) COLLATE utf8mb3_persian_ci NOT NULL,
  PRIMARY KEY (`type`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.licenses: ~5 rows (approximately)
...
-- Dumping structure for table irspring.mdt_reports
...
-- Dumping data for table irspring.mdt_reports: ~67 rows (approximately)
...
-- Dumping structure for table irspring.mdt_warrants
...
-- Dumping data for table irspring.mdt_warrants: ~0 rows (approximately)
...
-- Dumping structure for table irspring.meeta_accessory_inventory
...
-- Dumping data for table irspring.meeta_accessory_inventory: ~0 rows (approximately)
/*!40000 ALTER TABLE `meeta_accessory_inventory` DISABLE KEYS */;
/*!40000 ALTER TABLE `meeta_accessory_inventory` ENABLE KEYS */;

-- Dumping structure for table irspring.meeta_vehicle_trunk
...
CREATE TABLE IF NOT EXISTS `meeta_vehicle_trunk` (
  ...
  KEY `owner` (`owner`)
) ENGINE=InnoDB AUTO_INCREMENT=11731 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.meeta_vehicle_trunk: ~0 rows (approximately)
/*!40000 ALTER TABLE `meeta_vehicle_trunk` DISABLE KEYS */;
/*!40000 ALTER TABLE `meeta_vehicle_trunk` ENABLE KEYS */;

-- Dumping structure for table irspring.owned_bags
...
CREATE TABLE IF NOT EXISTS `owned_properties` (
  ...
  `owner` varchar(60) COLLATE utf8mb3_persian_ci NOT NULL,
  KEY `name` (`name`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3034 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.owned_properties: ~0 rows (approximately)
/*!40000 ALTER TABLE `owned_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `owned_properties` ENABLE KEYS */;

-- Dumping structure for table irspring.owned_shops
...
-- Dumping data for table irspring.owned_shops: ~19 rows (approximately)
...
-- Dumping structure for table irspring.owned_vehicles
DROP TABLE IF EXISTS `owned_vehicles`;
CREATE TABLE IF NOT EXISTS `owned_vehicles` (
  `owner` varchar(30) COLLATE utf8mb3_persian_ci NOT NULL,
  `plate` varchar(12) COLLATE utf8mb3_persian_ci NOT NULL,
  `vehicle` longtext COLLATE utf8mb3_persian_ci NOT NULL,
  `type` varchar(20) COLLATE utf8mb3_persian_ci NOT NULL DEFAULT 'car',
  `stored` tinyint(1) NOT NULL DEFAULT 0,
  `job` varchar(20) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `lasthouse` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.owned_vehicles: ~11 rows (approximately)
...
-- Dumping structure for table irspring.owned_vehicles_headlights
...
-- Dumping data for table irspring.owned_vehicles_headlights: ~17 rows (approximately)
...
-- Dumping structure for table irspring.phone_app_chat
...
-- Dumping data for table irspring.phone_app_chat: ~325 rows (approximately)
/*!40000 ALTER TABLE `phone_app_chat` DISABLE KEYS */;
INSERT INTO `phone_app_chat` (`id`, `channel`, `message`, `time`) VALUES
	(28, 'gun', 'hello', '2020-04-20 03:17:23'),
	(29, 'gun', 'xd', '2020-04-20 03:17:31'),
	(30, 'gun', 'bia', '2020-04-20 03:17:37'),
	(31, 'gun', 'berim kun bokonim', '2020-04-20 03:17:43'),
	(32, 'gun', 'bruh', '2020-04-20 03:17:50'),
	(33, 'mh', 'salam', '2020-04-22 01:06:23'),
	(34, 'levi', 'SucK', '2020-04-22 11:23:45'),
	(35, 'ah', 'kasi hast???', '2020-04-24 17:41:18'),
	(36, 'saman', 'salam', '2020-04-26 05:07:25'),
	(37, 'amirfn', 'salam', '2020-04-26 05:07:51'),
	(38, 'sd', 'sdf', '2020-04-26 11:59:15'),
	(39, 'foxteam', 'Fuck off', '2020-05-01 15:41:17'),
	(40, 'foxteam', 'ali bebin ka kard !?', '2020-05-01 15:41:29'),
	(41, 'mafia', 's', '2020-05-04 01:21:07'),
	(42, 'mafia', 'salam be hamge', '2020-05-04 01:21:16'),
	(43, 'df', 'sda', '2020-05-04 04:01:33'),
	(44, 'test', 'hello', '2020-05-06 16:55:23'),
	(45, 'policedepatment', '0939', '2020-05-07 04:45:17'),
	(46, 'policedepatment', '0939945059', '2020-05-07 04:45:26'),
	(47, 'policedepatment', 'tomy', '2020-05-07 04:45:40'),
	(48, 'azwolf', 'salam', '2020-05-07 16:06:37'),
	(49, 'aznwolf', 'az', '2020-05-07 16:06:57'),
	(50, 'e', 'e', '2020-05-10 05:22:42'),
	(51, 'energy', 's', '2020-05-10 12:11:58'),
	(52, 'energy', 'lm', '2020-05-11 04:22:52'),
	(53, 'badboys', 'slam', '2020-05-11 09:48:43'),
	(54, 'badboys', 'slam', '2020-05-11 09:48:44'),
	(55, 'energy', 'salam kase hast??', '2020-05-12 06:33:34'),
	(56, 'energy', 'badansaz', '2020-05-13 00:15:19'),
	(57, 'o', 'gg', '2020-05-28 23:50:07'),
	(58, 'smgmikham', 'smg mikham kasi nadare', '2020-05-30 10:17:09'),
	(59, 'smgmikham', 'slm kasi smg mifroshe', '2020-06-01 19:04:31'),
	(60, 'smgmikham', '?', '2020-06-01 19:04:34'),
	(61, 'bazo', 'slm', '2020-06-02 02:27:47'),
	(62, 'bazo', 'salam amer damagh', '2020-06-02 02:35:36'),
	(63, 'energy', 's', '2020-06-04 10:47:56'),
	(64, 'energy', 's', '2020-06-04 10:47:59'),
	(65, 'energy', 's', '2020-06-04 10:48:01'),
	(66, 'hello', 'salam', '2020-06-05 13:27:43'),
	(67, 'chat', 'hey', '2020-06-06 13:34:20'),
	(68, 'sherif', 'sdfg', '2020-06-06 16:01:03'),
	(69, 'shf', 'slm', '2020-06-06 16:01:15'),
	(70, 'sheriff', 'salam', '2020-06-06 16:01:31'),
	(71, 'sheriff', 'gostakh', '2020-06-06 16:01:47'),
	(72, 'sheriff', 'slm', '2020-06-06 16:01:47'),
	(73, 'shriff', '123', '2020-06-06 16:01:49'),
	(74, 'sheriff', '123', '2020-06-06 16:02:19'),
	(75, 'sheriff', 'inja okeye?', '2020-06-06 17:11:38'),
	(76, 'sheriff', '???', '2020-06-06 17:11:43'),
	(77, 's', 's', '2020-06-07 01:00:26'),
	(78, 'oo', 'mcnici ba takhfifi vije', '2020-06-07 03:05:47'),
	(79, 'taximans', 'bmd', '2020-06-07 15:36:04'),
	(80, 'fuckthepolice', 'sasda', '2020-06-10 01:12:05'),
	(81, 'ballas', 'SLam', '2020-06-13 21:49:09'),
	(82, 'ballas', 'Baaaah', '2020-06-13 21:49:19'),
	(83, 'secret', 'salam', '2020-06-14 23:07:38'),
	(84, 'gangforhame', 'chetorin', '2020-06-15 18:49:03'),
	(85, 'sa', 'slm', '2020-06-16 22:24:36'),
	(86, 'sa', 'amir', '2020-06-17 02:14:45'),
	(87, 'sinaghaf', 'salam', '2020-06-17 17:36:27'),
	(88, 'siktirchat', 'siktir chat', '2020-07-04 15:49:46'),
	(89, 'siktirchat', 'SALAM', '2020-07-04 15:50:00'),
	(90, 'siktirchat', 'kirrrrrrrrrrrrr', '2020-07-06 02:44:19'),
	(91, 'siktirchat', 'feghat kashoo', '2020-07-06 02:44:33'),
	(92, 'siktirchat', 'siktir chat', '2020-07-06 23:28:25'),
	(93, 'aa', 'salam', '2020-07-13 17:50:32'),
	(94, 'aa', '1111', '2020-07-13 17:50:40'),
	(95, 'khantaqi', 'salam', '2020-07-16 14:37:04'),
	(96, 'khantaqi', 'salam khedmat shoma dostan aziz', '2020-07-16 14:37:25'),
	(97, 'konia', 'SALAM KONIA', '2020-07-20 18:47:32'),
	(98, 'venomous', 'k', '2020-07-20 21:58:05'),
	(99, 'a', 'tof tof kerak moft', '2020-07-20 23:42:55'),
	(100, 'joon', 'SALAM', '2020-07-21 03:17:29'),
	(101, 'm', 'SLM', '2020-07-24 18:14:09'),
	(102, 'parsaravandel', 'salam', '2020-07-26 17:50:14'),
	(103, 'miladi', 'salam', '2020-07-30 01:29:38'),
	(104, 'nema', 'salam', '2020-08-05 06:43:56'),
	(105, 'fakes', 'helllo', '2020-08-05 09:13:11'),
	(106, 'mafia', 'sdsa', '2020-08-05 12:57:10'),
	(107, 'mafia', 'salam', '2020-08-05 12:58:03'),
	(108, 'mafia', 'slm', '2020-08-05 12:58:08'),
	(109, 'mafia', 'khosh omadam', '2020-08-05 12:58:15'),
	(110, 'mafia', 'bale', '2020-08-05 12:58:21'),
	(111, 'mafia', 'mnm', '2020-08-05 12:58:51'),
	(112, 'mafia', 'salam', '2020-08-05 12:59:01'),
	(113, 'mafia', 'shab shode porstare', '2020-08-05 12:59:03'),
	(114, 'mafia', 'usf slm', '2020-08-05 12:59:04'),
	(115, 'mafia', 'cheshmak bezn dobare', '2020-08-05 12:59:14'),
	(116, 'mafia', 'SALAMM', '2020-08-05 12:59:15'),
	(117, 'mafia', 'aqe gofti mn kiam', '2020-08-05 12:59:22'),
	(118, 'mafia', 'MAFIAAAAAAAAAAAAAAAAAAAAAAAAAA', '2020-08-05 12:59:28'),
	(119, 'mafia', 'hey', '2020-08-05 12:59:37'),
	(120, 'mafia', 'mn goz darm', '2020-08-05 12:59:41'),
	(121, 'mafia', 'hellp', '2020-08-05 12:59:41'),
	(122, 'mafia', 'HAMATONO LOH MIDAM', '2020-08-05 12:59:43'),
	(123, 'mafia', 'GPS BEDID', '2020-08-05 12:59:47'),
	(124, 'mafia', 'be ki', '2020-08-05 12:59:53'),
	(125, 'mafia', 'u3f nob sage', '2020-08-05 12:59:55'),
	(126, 'mafia', 'bedam', '2020-08-05 12:59:56'),
	(127, 'mafia', 'BE KHODAM', '2020-08-05 12:59:58'),
	(128, 'mafia', 'babat noob sage', '2020-08-05 13:00:03'),
	(129, 'mafia', 'doroste', '2020-08-05 13:00:03'),
	(130, 'mafia', 'dayooos', '2020-08-05 13:00:13'),
	(131, 'mafia', 'noob sag XD', '2020-08-05 13:00:14'),
	(132, 'mafia', 'BOSAM KONID', '2020-08-05 13:00:15'),
	(133, 'mafia', 'hi beach', '2020-08-05 13:00:16'),
	(134, 'mafia', 'blz be chokh raft', '2020-08-05 13:00:21'),
	(135, 'mafia', ':D', '2020-08-05 13:00:25'),
	(136, 'mafia', ':D', '2020-08-05 13:00:28'),
	(137, 'mafia', 'stream nmiaeed XD\\', '2020-08-05 13:00:33'),
	(138, 'mafia', 'fuck mafia', '2020-08-05 13:00:42'),
	(139, 'mafia', 'BLZ CHERA BE CHOKH RAFT ?', '2020-08-05 13:00:43'),
	(140, 'mafia', 'ridid', '2020-08-05 13:00:44'),
	(141, 'mafia', 'fosh gozashtam bara paiini', '2020-08-05 13:00:48'),
	(142, 'mafia', 'sar ye seri dastana', '2020-08-05 13:00:58'),
	(143, 'mafia', 'usef kheili shakh shide chat', '2020-08-05 13:01:23'),
	(144, 'mafia', ':D', '2020-08-05 13:01:41'),
	(145, 'mafia', 'babayaga companysh kharabe', '2020-08-05 13:01:41'),
	(146, 'mafia', 'shakhaie majazzi', '2020-08-05 13:01:43'),
	(147, 'mafia', 'maro dor nandaz u3f', '2020-08-05 13:01:52'),
	(148, 'mafia', 'ali jonoooooooooo', '2020-08-05 13:02:17'),
	(149, 'mafia', 'alireza shabi jhony shode', '2020-08-05 13:02:36'),
	(150, 'mafia', 'you 3 f #delvan', '2020-08-05 13:02:41'),
	(151, 'mafia', 'hey bitch', '2020-08-05 13:02:42'),
	(152, 'mafia', 'usf asl bde', '2020-08-05 13:02:43'),
	(153, 'mafia', 'dayoos', '2020-08-05 13:02:51'),
	(154, 'mafia', '/bring 145', '2020-08-05 13:03:05'),
	(155, 'mafia', 'salam', '2020-08-05 13:03:18'),
	(156, 'mafia', 'MN KON MIKHAM', '2020-08-05 13:03:20'),
	(157, 'mafia', 'asl bedin donbal konam', '2020-08-05 13:03:21'),
	(158, 'mafia', 'tamom kardim', '2020-08-05 13:03:45'),
	(159, 'mafia', 'KOOOOOOON', '2020-08-05 13:03:47'),
	(160, 'mafia', 'man dick mikham', '2020-08-05 13:03:47'),
	(161, 'mafia', 'kooooooooon', '2020-08-05 13:03:55'),
	(162, 'mafia', 'bediiiiiiiiiiin', '2020-08-05 13:03:59'),
	(163, 'mafia', 'paiini khare', '2020-08-05 13:03:59'),
	(164, 'mafia', 'koooooooooooooooooon', '2020-08-05 13:04:02'),
	(165, 'mafia', 'KIR KI AZ HAME BOLAND TARE', '2020-08-05 13:04:19'),
	(166, 'mafia', 'shab sa.at 3 davaaa', '2020-08-05 13:04:22'),
	(167, 'mafia', 'pornhub.com', '2020-08-05 13:04:42'),
	(168, 'mafia', 'BIA POSHT MADRESE', '2020-08-05 13:04:43'),
	(169, 'mafia', 'lets gay', '2020-08-05 13:04:55'),
	(170, 'mafia', 'khaye nadari', '2020-08-05 13:04:56'),
	(171, 'mafia', 'zeid mikham', '2020-08-05 13:05:12'),
	(172, 'mafia', 'harki dare biad dam dar', '2020-08-05 13:05:19'),
	(173, 'mafia', 'baradaran zagraz . com', '2020-08-05 13:05:19'),
	(174, 'mafia', 'mano dar youtube subscribe konid', '2020-08-05 13:05:21'),
	(175, 'mafia', 'mn ye pesar mikham', '2020-08-05 13:05:27'),
	(176, 'mafia', 'man yek streamer kooni am', '2020-08-05 13:05:42'),
	(177, 'mafia', 'kon nabod ?', '2020-08-05 13:05:53'),
	(178, 'mafia', 'khaye mali nakoninnnnnn', '2020-08-05 13:05:54'),
	(179, 'mafia', 'salam koooni', '2020-08-05 13:05:56'),
	(180, 'mafia', '1 bar koon = 500 k', '2020-08-05 13:06:12'),
	(181, 'mafia', 'mn konma', '2020-08-05 13:06:18'),
	(182, 'mafia', 'khaye mali nakon satar', '2020-08-05 13:06:21'),
	(183, 'mafia', '1 subscribe = 1 koon', '2020-08-05 13:06:23'),
	(184, 'mafia', 'kon khod ra be ma beseparid', '2020-08-05 13:06:31'),
	(185, 'mafia', '1 koon = 1$', '2020-08-05 13:06:43'),
	(186, 'mafia', 'age 10 t donate konid too aparat lokht misham', '2020-08-05 13:06:53'),
	(187, 'mafia', 'kiaomin nistam', '2020-08-05 13:07:00'),
	(188, 'mafia', 'daus mno kharab nkon', '2020-08-05 13:07:14'),
	(189, 'mafia', 'lokht pashmi nmikhaym', '2020-08-05 13:07:15'),
	(190, 'mafia', 'har ki j nade koonie', '2020-08-05 13:07:17'),
	(191, 'mafia', 'paiini khare', '2020-08-05 13:07:39'),
	(192, 'mafia', 'harki nage albaloo', '2020-08-05 13:07:50'),
	(193, 'mafia', 'mn u3fam', '2020-08-05 13:07:53'),
	(194, 'mafia', 'kon kon kon kon az hame rang', '2020-08-05 13:07:54'),
	(195, 'mafia', 'man kooni am', '2020-08-05 13:08:01'),
	(196, 'mafia', 'fuck me', '2020-08-05 13:08:21'),
	(197, 'mafia', 'alireza is johnny sins', '2020-08-05 13:08:24'),
	(198, 'mafia', 'man kiaomin koooni aaaam', '2020-08-05 13:08:45'),
	(199, 'mafia', 'alireza ba in kalash che sexy shode', '2020-08-05 13:08:46'),
	(200, 'mafia', 'fuck meeeeee', '2020-08-05 13:08:49'),
	(201, 'mafia', 'ahhhhhhhhhhh', '2020-08-05 13:08:56'),
	(202, 'mafia', 'offfffffffff', '2020-08-05 13:08:59'),
	(203, 'mafia', 'man roo sattar crush daram', '2020-08-05 13:09:06'),
	(204, 'mafia', 'mn kon mikhammmmm', '2020-08-05 13:09:07'),
	(205, 'mafia', 'yeeeeeh', '2020-08-05 13:09:11'),
	(206, 'mafia', 'bia koon bedam', '2020-08-05 13:09:18'),
	(207, 'mafia', 'mn sattar ro mikham bokonaaaaaaammmmmmmmmmmmmm', '2020-08-05 13:09:20'),
	(208, 'mafia', 'biaaaaaa', '2020-08-05 13:09:25'),
	(209, 'mafia', 'omadam', '2020-08-05 13:09:34'),
	(210, 'hanipink', 'SALAAAAAAAAAAAM', '2020-08-08 07:31:01'),
	(211, 'mafia', 'bache khoshgel', '2020-08-11 11:57:30'),
	(212, 'mafia', 'slm bekiram', '2020-08-11 11:58:10'),
	(213, 'infinity', 'slm', '2020-08-14 02:30:06'),
	(214, 'infinity', 'Slm', '2020-08-14 02:36:10'),
	(215, 'infinity', 'kose amaton', '2020-08-14 02:36:14'),
	(216, 'infinity', 'XD', '2020-08-14 02:36:20'),
	(217, 'infinity', 'kiramam nistid', '2020-08-14 02:36:24'),
	(218, 'infinity', 'noob', '2020-08-14 02:36:31'),
	(219, 'infinity', 'namal', '2020-08-14 02:37:17'),
	(220, 'infinity', 'kojayid biam', '2020-08-14 02:43:17'),
	(221, 'infinity', 'tokhme saga ja mondammmm', '2020-08-14 04:58:14'),
	(222, 'infinity', 'sety shomarat ro bde', '2020-08-15 03:19:13'),
	(223, 'sgd', 'FG', '2020-08-15 04:43:50'),
	(224, 'sgd', 'gr', '2020-08-15 04:43:53'),
	(225, 'infinity', 's', '2020-08-18 01:52:59'),
	(226, 'mamad', 'salaaaaaaaaaaam', '2020-08-27 19:30:36'),
	(227, 'mechanic', 'hame bache khoshgla', '2020-08-30 23:32:17'),
	(228, 'mechanic', 'fuck you all', '2020-08-30 23:33:07'),
	(229, 'mechanic', 'farar konid', '2020-08-31 01:51:00'),
	(230, 'selam', 'nabar', '2020-08-31 23:19:21'),
	(231, 'siktirchat', 'hello siktir chati ha', '2020-09-03 00:14:56'),
	(232, 'siktir', 'slm', '2020-09-03 19:52:35'),
	(233, 'siktir', 'KIRRRRRRRRRRRRRRRRRRRRR', '2020-09-03 19:53:30'),
	(234, 'siktir', 'kir khar', '2020-09-03 19:53:34'),
	(235, 'siktir', 'KOSKESH KIRE KHAR SAVAR', '2020-09-03 19:53:48'),
	(236, 'siktir', 'kirm dhn mehrbod', '2020-09-03 19:53:55'),
	(237, 'siktir', 'KIR DHNE MRX', '2020-09-03 19:54:04'),
	(238, 'siktir', 'kir tu dhnnnnn mrx', '2020-09-03 19:54:13'),
	(239, 'mari', 'salam', '2020-09-04 14:28:17'),
	(240, 'saghj', 'salam', '2020-09-04 15:13:59'),
	(241, 'infinity', 'slm', '2020-09-04 18:39:20'),
	(242, 'mechanic', '# Mechanic.', '2020-09-07 13:05:12'),
	(243, 'azoblackmarket', 'Pistol 50 = 90000$', '2020-09-10 07:03:04'),
	(244, 'azoblackmarket', 'Pistol = 40000$', '2020-09-10 07:03:24'),
	(245, 'azoblackmarket', 'Combat Pistol = 70000$', '2020-09-10 07:03:40'),
	(246, 'kos', 'Slm bache ha', '2020-09-16 00:58:44'),
	(247, 'gardesh', 'salam', '2020-09-17 06:09:56'),
	(248, 'gardesh', 'slm', '2020-09-17 06:10:53'),
	(249, 'gardesh', 'sakam', '2020-09-17 06:10:59'),
	(250, 'gardesh', 'slm mn mahiam', '2020-09-17 06:11:05'),
	(251, 'gardesh', 'man asgharam', '2020-09-17 06:11:18'),
	(252, 'gardesh', 'nokaram', '2020-09-17 20:32:59'),
	(253, 'gardesh', 'gorgali vared mishavad', '2020-09-17 20:33:09'),
	(254, 'gardesh', 'emshab barname nadarim ?', '2020-09-18 01:19:50'),
	(255, 'taxi', 'taxi', '2020-09-18 01:38:42'),
	(256, 'gardesh', 'bache barnameii nist?', '2020-09-18 04:36:56'),
	(257, 'dads', 'dffd', '2020-09-19 10:16:29'),
	(258, 'sat', 'salam', '2020-09-19 10:17:07'),
	(259, 'sat', 'sat', '2020-09-19 10:17:18'),
	(260, 'sat', 'hello', '2020-09-19 10:17:21'),
	(261, 'sat', 'salam', '2020-09-19 10:17:24'),
	(262, 'sat', 'welcome', '2020-09-19 10:17:25'),
	(263, 'sat', 'lets goooo', '2020-09-19 10:17:32'),
	(264, 'sat', 'haji che bahahle', '2020-09-19 10:17:41'),
	(265, 'sat', 'fuck the bitches', '2020-09-19 10:17:42'),
	(266, 'sat', 'yeee', '2020-09-19 10:17:47'),
	(267, 'sat', 'areeee', '2020-09-19 10:17:50'),
	(268, 'alikashi', '1', '2020-09-20 16:37:08'),
	(269, 'alikashi', '2', '2020-09-20 16:37:10'),
	(270, 'alikashi', '3', '2020-09-20 16:37:12'),
	(271, 'sat', 'salam', '2020-09-20 22:40:32'),
	(272, 'sat', 'hello', '2020-09-20 22:40:44'),
	(273, 'sat', 'fsdf', '2020-09-20 22:40:45'),
	(274, 'sat', 'fuck yuo', '2020-09-20 22:40:48'),
	(275, 'sat', 'hello', '2020-09-20 22:40:52'),
	(276, 'sat', '/;', '2020-09-20 22:40:54'),
	(277, 'sat', 'salam', '2020-09-20 22:41:34'),
	(278, 'sat', 'chetorid', '2020-09-20 22:41:42'),
	(279, 'sat', 'fuck youuuuuuuuuuuuuuuu', '2020-09-20 22:41:47'),
	(280, 'sat', 'fuck my asssssss', '2020-09-20 22:41:56'),
	(281, 'sat', 'hellllllllllllllllllllllllllllllllllllllllloooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo', '2020-09-20 22:42:01'),
	(282, 'sat', 'alooo', '2020-09-20 22:42:07'),
	(283, 'sat', 'alo', '2020-09-20 22:42:11'),
	(284, 'sat', 'alo', '2020-09-20 22:42:14'),
	(285, 'sat', 'alo', '2020-09-20 22:42:15'),
	(286, 'sat', 'alo', '2020-09-20 22:42:16'),
	(287, 'sat', 'alo', '2020-09-20 22:42:18'),
	(288, 'sat', 'alo', '2020-09-20 22:42:20'),
	(289, 'sat', 'bye', '2020-09-20 22:42:22'),
	(290, 'sat', 'aloo', '2020-09-20 22:42:23'),
	(291, 'sat', 'byeeeee', '2020-09-20 22:42:25'),
	(292, 'sat', 'byeeeeeeeeeeeeeeee', '2020-09-20 22:42:27'),
	(293, 'sat', 'y', '2020-09-20 22:42:28'),
	(294, 'sat', 'y', '2020-09-20 22:42:29'),
	(295, 'sat', 'y', '2020-09-20 22:42:31'),
	(296, 'sat', 'o', '2020-09-20 22:42:33'),
	(297, 'sat', 'o', '2020-09-20 22:42:36'),
	(298, 'sat', 'o', '2020-09-20 22:42:37'),
	(299, 'sat', 'u', '2020-09-20 22:42:39'),
	(300, 'sat', 'u', '2020-09-20 22:42:41'),
	(301, 'sat', 'u', '2020-09-20 22:42:42'),
	(302, 'sat', 's', '2020-09-20 22:42:44'),
	(303, 'sat', 's', '2020-09-20 22:42:45'),
	(304, 'sat', 's', '2020-09-20 22:42:47'),
	(305, 'sat', 'e', '2020-09-20 22:42:48'),
	(306, 'sat', 'e', '2020-09-20 22:42:50'),
	(307, 'sat', 'e', '2020-09-20 22:42:51'),
	(308, 'sat', 'f', '2020-09-20 22:42:52'),
	(309, 'sat', 'f', '2020-09-20 22:42:54'),
	(310, 'sat', 'f', '2020-09-20 22:42:55'),
	(311, 'sat', ':)', '2020-09-20 22:43:04'),
	(312, 'sat', 'sdasds', '2020-09-20 23:22:59'),
	(313, 'aliver', 'salam', '2020-09-21 03:13:01'),
	(314, 'aliver', 'salam', '2020-09-21 03:13:09'),
	(315, 'blackgun', 'ksi hast gun mikham', '2020-09-21 03:34:41'),
	(316, 'aliver', 'yaser yaser mamad', '2020-09-21 03:35:15'),
	(317, 'aliver', 's', '2020-09-21 03:35:22'),
	(318, 'aliver', 's', '2020-09-21 03:35:51'),
	(319, 'aliver', 'miow', '2020-09-21 03:36:03'),
	(320, 'aliver', 'SALAM', '2020-09-21 03:36:16'),
	(321, 'aliver', 'MoZ', '2020-09-21 03:41:30'),
	(322, 'aliver', 'freq?', '2020-09-21 23:12:06'),
	(323, 'aliver', 'nade nade', '2020-09-21 23:12:12'),
	(324, 'divass', 's', '2020-09-22 00:19:38'),
	(325, 'divass', 's back', '2020-09-22 00:19:45'),
	(326, 'aliver', 'kojaee', '2020-09-22 00:33:41'),
	(327, 'aliver', 'ba hosin kar daram', '2020-09-22 00:33:52'),
	(328, 'aliver', 'alo', '2020-09-22 00:35:14'),
	(329, 'aliver', '?', '2020-09-22 00:35:29'),
	(330, 'aliver', 'chekhe', '2020-09-22 00:36:16'),
	(331, 'aliver', 'kojaee alan?', '2020-09-22 00:36:41'),
	(332, 'aliver', 'haminjam', '2020-09-22 00:37:09'),
	(333, 'aliver', 'mechanici', '2020-09-22 00:38:49'),
	(334, 'sat', 'salam', '2020-09-22 02:05:55'),
	(335, 'sat', 'rd', '2020-09-22 02:06:04'),
	(336, 'aliver', 'mikham pare konin body cama ham roshan', '2020-09-22 09:24:26'),
	(337, 'aliver', 'mashallah', '2020-09-22 09:24:33'),
	(338, 'aliver', 'bachehaye jacky too shahran', '2020-09-23 01:39:01'),
	(339, 'aliver', 'fk knm jacky oomade', '2020-09-23 02:12:23'),
	(340, 'aliver', 'yekio didam', '2020-09-23 02:12:30'),
	(341, 'aliver', 'khob nemitonim kari konim', '2020-09-23 02:12:35'),
	(342, 'aliver', 'havaset bashe migam', '2020-09-23 02:12:50'),
	(343, 'aliver', 'okeye khaliam', '2020-09-23 02:12:56'),
	(344, 'aliver', 'lebaseshon chie hamon mask?w', '2020-09-23 02:15:19'),
	(345, 'aliver', 're', '2020-09-23 02:15:40'),
	(346, 'aliver', 'radio chande?', '2020-09-24 22:58:23'),
	(347, 'aliver', '?', '2020-09-24 22:58:26'),
	(348, 'aliver', 'kasi nist?', '2020-09-24 23:01:46'),
	(349, 'aliver', '?', '2020-09-24 23:01:47'),
	(350, 'sat', 'salam', '2020-09-25 11:06:17'),
	(351, 'sat', 's', '2020-09-25 11:06:21'),
	(352, 'reza', 'SALAM', '2020-09-26 10:11:54');
/*!40000 ALTER TABLE `phone_app_chat` ENABLE KEYS */;

-- Dumping structure for table irspring.phone_calls
...
CREATE TABLE IF NOT EXISTS `phone_calls` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2224 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.phone_calls: ~0 rows (approximately)
/*!40000 ALTER TABLE `phone_calls` DISABLE KEYS */;
/*!40000 ALTER TABLE `phone_calls` ENABLE KEYS */;

-- Dumping structure for table irspring.phone_messages
...
CREATE TABLE IF NOT EXISTS `phone_messages` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=21864 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.phone_messages: 24 rows
/*!40000 ALTER TABLE `phone_messages` DISABLE KEYS */;
INSERT INTO `phone_messages` (`id`, `transmitter`, `receiver`, `message`, `time`, `isRead`, `owner`) VALUES
	(21851, 'mechanic', '09392221544', 'GPS: -337.03192138672, -138.9094543457', '2021-06-25 09:06:14', 0, 0),
	(21850, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 09:06:13', 0, 0),
	(21849, 'mechanic', '09392221544', 'GPS: -336.4475402832, -137.46043395996', '2021-06-25 09:04:25', 0, 0),
	(21848, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 09:04:24', 0, 0),
	(21847, 'mechanic', '09392221544', 'GPS: -336.4475402832, -137.46043395996', '2021-06-25 09:02:11', 0, 0),
	(21846, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 09:02:11', 0, 0),
	(21845, 'mechanic', '09392221544', 'GPS: -334.48382568359, -137.19175720215', '2021-06-25 09:02:07', 0, 0),
	(21844, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 09:02:07', 0, 0),
	(21843, 'mechanic', '09392221544', 'GPS: -340.12866210938, -137.45845031738', '2021-06-25 08:52:59', 0, 0),
	(21842, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 08:52:59', 0, 0),
	(21841, 'mechanic', '09392221544', 'GPS: -342.58004760742, -136.95767211914', '2021-06-25 08:49:51', 0, 0),
	(21840, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 08:49:51', 0, 0),
	(21852, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 09:06:40', 0, 0),
	(21853, 'mechanic', '09392221544', 'GPS: -337.03192138672, -138.9094543457', '2021-06-25 09:06:40', 0, 0),
	(21854, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 10:37:48', 0, 0),
	(21855, 'mechanic', '09392221544', 'GPS: -337.01629638672, -138.79888916016', '2021-06-25 10:37:48', 0, 0),
	(21856, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 10:39:51', 0, 0),
	(21857, 'mechanic', '09392221544', 'GPS: -337.01629638672, -138.79888916016', '2021-06-25 10:39:51', 0, 0),
	(21858, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 10:41:01', 0, 0),
	(21859, 'mechanic', '09392221544', 'GPS: -338.80368041992, -137.38055419922', '2021-06-25 10:41:01', 0, 0),
	(21860, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 10:41:04', 0, 0),
	(21861, 'mechanic', '09392221544', 'GPS: -338.81155395508, -137.37893676758', '2021-06-25 10:41:05', 0, 0),
	(21862, 'mechanic', '09392221544', 'From #09392221544 : Salam Man Mechanic Niaz Daram Dar Garage Montazer Shoma Hastam', '2021-06-25 10:44:01', 0, 0),
	(21863, 'mechanic', '09392221544', 'GPS: -338.81155395508, -137.37893676758', '2021-06-25 10:44:02', 0, 0);
/*!40000 ALTER TABLE `phone_messages` ENABLE KEYS */;

-- Dumping structure for table irspring.phone_users_contacts
...
CREATE TABLE IF NOT EXISTS `phone_users_contacts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=202 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.phone_users_contacts: 197 rows
...
-- Dumping structure for table irspring.playerhousing
...
-- Dumping data for table irspring.playerhousing: ~0 rows (approximately)
/*!40000 ALTER TABLE `playerhousing` DISABLE KEYS */;
/*!40000 ALTER TABLE `playerhousing` ENABLE KEYS */;

-- Dumping structure for table irspring.police_ext
...
-- Dumping data for table irspring.police_ext: ~39 rows (approximately)
/*!40000 ALTER TABLE `police_ext` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `police_ext` ENABLE KEYS */;

-- Dumping structure for table irspring.properties
DROP TABLE IF EXISTS `properties`;
CREATE TABLE IF NOT EXISTS `properties` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `label` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `entering` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `exit` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `inside` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `outside` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `ipls` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT '[]',
  `gateway` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `is_single` int(11) DEFAULT NULL,
  `is_room` int(11) DEFAULT NULL,
  `is_gateway` int(11) DEFAULT NULL,
  `room_menu` varchar(255) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  `price` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `name` (`name`),
  KEY `inside` (`inside`),
...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.properties: ~0 rows (approximately)
/*!40000 ALTER TABLE `properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `properties` ENABLE KEYS */;

-- Dumping structure for table irspring.properties_inventory
...
CREATE TABLE IF NOT EXISTS `properties_inventory` (
  ...
  `label_weapon` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `propertie_id` (`propertie_id`),
  KEY `owner` (`owner`)
) ENGINE=InnoDB AUTO_INCREMENT=931 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.properties_inventory: ~0 rows (approximately)
/*!40000 ALTER TABLE `properties_inventory` DISABLE KEYS */;
/*!40000 ALTER TABLE `properties_inventory` ENABLE KEYS */;

-- Dumping structure for table irspring.rented_vehicles
DROP TABLE IF EXISTS `rented_vehicles`;
CREATE TABLE IF NOT EXISTS `rented_vehicles` (
  `vehicle` varchar(60) COLLATE utf8mb3_persian_ci NOT NULL,
  `plate` varchar(12) COLLATE utf8mb3_persian_ci NOT NULL,
  `player_name` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `base_price` int(11) NOT NULL,
  `rent_price` int(11) NOT NULL,
  `owner` varchar(22) COLLATE utf8mb3_persian_ci NOT NULL,
  PRIMARY KEY (`plate`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.rented_vehicles: ~0 rows (approximately)
/*!40000 ALTER TABLE `rented_vehicles` DISABLE KEYS */;
/*!40000 ALTER TABLE `rented_vehicles` ENABLE KEYS */;

-- Dumping structure for table irspring.reports
...
-- Dumping data for table irspring.reports: ~20 rows (approximately)
...
-- Dumping structure for table irspring.shipments
...
-- Dumping data for table irspring.shipments: ~0 rows (approximately)
/*!40000 ALTER TABLE `shipments` DISABLE KEYS */;
/*!40000 ALTER TABLE `shipments` ENABLE KEYS */;

-- Dumping structure for table irspring.shops
...
-- Dumping data for table irspring.shops: ~0 rows (approximately)
/*!40000 ALTER TABLE `shops` DISABLE KEYS */;
/*!40000 ALTER TABLE `shops` ENABLE KEYS */;

-- Dumping structure for table irspring.trunk_inventory
DROP TABLE IF EXISTS `trunk_inventory`;
CREATE TABLE IF NOT EXISTS `trunk_inventory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `plate` varchar(8) COLLATE utf8mb3_persian_ci NOT NULL,
  `data` text COLLATE utf8mb3_persian_ci NOT NULL,
  `owned` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `plate` (`plate`) USING BTREE,
  KEY `owned` (`owned`)
) ENGINE=InnoDB AUTO_INCREMENT=12660 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.trunk_inventory: ~0 rows (approximately)
/*!40000 ALTER TABLE `trunk_inventory` DISABLE KEYS */;
/*!40000 ALTER TABLE `trunk_inventory` ENABLE KEYS */;

-- Dumping structure for table irspring.users
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  PRIMARY KEY (`identifier`),
  KEY `id` (`id`),
  KEY `playerName` (`playerName`(191)),
  KEY `tattoos` (`tattoos`(191)),
  KEY `is_dead` (`is_dead`),
  KEY `skin` (`skin`(191)),
  KEY `loadout` (`loadout`(191)),
  KEY `inventory` (`inventory`(191))
) ENGINE=InnoDB AUTO_INCREMENT=8702 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.users: ~11 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `identifier`, `license`, `playerName`, `money`, `bank`, `permission_level`, `group`, `position`, `vip`, `inventory`, `loadout`, `gender`, `skin`, `gang`, `gang_grade`, `job`, `job_grade`, `divisions`, `badge`, `status`, `is_dead`, `last_property`, `jail`, `jailreason`, `dateofbirth`, `height`, `armour`, `tattoos`, `IsBeingCprd`, `lastchange`, `IsDetective`, `IsSwat`, `IsSheriff`, `IsHR`, `IsXray`, `Assign`, `timePlay`, `phone_number`, `streamerpack`, `question_rp`, `rp_xp`, `rp_rank`, `lastdigits`) VALUES
	...
	(8697, 'steam:1100001452fd076', 'license:c758e851f0757f7c5b67ef3bbb7a23e1a23f4c53', '', 10000, 100000, 0, 'user', '{"x":-228.11,"y":-905.64,"z":32.22}', NULL, '[{"count":1,"item":"phone"},{"count":1,"item":"gps"},{"count":5,"item":"water"},{"count":5,"item":"bread"}]', '[]', NULL, NULL, 'nogang', 0, 'unemployed', 0, 'police', 0, '[{"percent":99.8,"val":998000,"name":"hunger"},{"percent":99.85000000000001,"val":998500,"name":"thirst"},{"percent":100,"val":100,"name":"health"},{"percent":0,"val":0,"name":"armor"}]', 0, NULL, '{"type":0,"time":0,"part":0}', NULL, NULL, NULL, 0, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 26, '09398300973', 0, 0, 0, 1, 1234),
...
-- Dumping structure for table irspring.user_convictions
...
-- Dumping data for table irspring.user_convictions: ~174 rows (approximately)
...
-- Dumping structure for table irspring.user_documents
...
-- Dumping data for table irspring.user_documents: ~0 rows (approximately)
/*!40000 ALTER TABLE `user_documents` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_documents` ENABLE KEYS */;

-- Dumping structure for table irspring.user_licenses
...
CREATE TABLE IF NOT EXISTS `user_licenses` (
  ...
  KEY `type` (`type`),
  KEY `owner` (`owner`)
) ENGINE=InnoDB AUTO_INCREMENT=6025 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.user_licenses: ~1 rows (approximately)
/*!40000 ALTER TABLE `user_licenses` DISABLE KEYS */;
INSERT INTO `user_licenses` (`id`, `type`, `owner`) VALUES
	(6024, 'weapon', 'steam:110000148adfa01');
/*!40000 ALTER TABLE `user_licenses` ENABLE KEYS */;

-- Dumping structure for table irspring.user_mdt
...
-- Dumping data for table irspring.user_mdt: ~0 rows (approximately)
/*!40000 ALTER TABLE `user_mdt` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_mdt` ENABLE KEYS */;

-- Dumping structure for table irspring.vehicles
DROP TABLE IF EXISTS `vehicles`;
CREATE TABLE IF NOT EXISTS `vehicles` (
  `name` varchar(60) COLLATE utf8mb3_persian_ci NOT NULL,
  `model` varchar(60) COLLATE utf8mb3_persian_ci NOT NULL,
  `price` int(11) NOT NULL,
  `category` varchar(60) COLLATE utf8mb3_persian_ci DEFAULT NULL,
  PRIMARY KEY (`model`) USING BTREE,
  KEY `price` (`price`),
  KEY `category` (`category`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.vehicles: ~222 rows (approximately)
...
-- Dumping structure for table irspring.vehicle_categories
...
-- Dumping data for table irspring.vehicle_categories: ~13 rows (approximately)
...
-- Dumping structure for table irspring.vehicle_sold
DROP TABLE IF EXISTS `vehicle_sold`;
CREATE TABLE IF NOT EXISTS `vehicle_sold` (
  `client` varchar(50) COLLATE utf8mb3_persian_ci NOT NULL,
  `model` varchar(50) COLLATE utf8mb3_persian_ci NOT NULL,
  `plate` varchar(50) COLLATE utf8mb3_persian_ci NOT NULL,
  `soldby` varchar(50) COLLATE utf8mb3_persian_ci NOT NULL,
  `date` varchar(50) COLLATE utf8mb3_persian_ci NOT NULL,
  PRIMARY KEY (`plate`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.vehicle_sold: ~0 rows (approximately)
/*!40000 ALTER TABLE `vehicle_sold` DISABLE KEYS */;
/*!40000 ALTER TABLE `vehicle_sold` ENABLE KEYS */;

-- Dumping structure for table irspring.warrants_list
...
-- Dumping data for table irspring.warrants_list: ~0 rows (approximately)
/*!40000 ALTER TABLE `warrants_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `warrants_list` ENABLE KEYS */;

-- Dumping structure for table irspring.weashops
DROP TABLE IF EXISTS `weashops`;
CREATE TABLE IF NOT EXISTS `weashops` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `zone` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `item` varchar(255) COLLATE utf8mb3_persian_ci NOT NULL,
  `price` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table irspring.weashops: ~4 rows (approximately)
